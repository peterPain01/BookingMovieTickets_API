...
public partial class BookingMovieTicketsContext : DbContext
{
    public BookingMovieTicketsContext() { }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Cinema>(entity =>
        {
            ...
            entity.Property(e => e.Name).HasMaxLength(32).IsUnicode(false).HasColumnName("name");
        });
        ...
        modelBuilder.Entity<Movie>(entity =>
        {
            ...
            entity.Property(e => e.GenreId).HasColumnName("genre_id");
            entity.Property(e => e.PlotSummary).HasColumnType("text").HasColumnName("plot_summary");
            entity
            ...
            entity
                .Property(e => e.PosterVerticalUrl)
                .HasMaxLength(255)
                .IsUnicode(false)
                .HasColumnName("poster_vertical_url");
            entity.Property(e => e.Rating).HasColumnType("decimal(3, 1)").HasColumnName("rating");
        ...
        modelBuilder.Entity<Voucher>(entity =>
        {
            ...
            entity.Property(e => e.VoucherCode).HasMaxLength(10).IsUnicode(false);
            entity.Property(e => e.VoucherType).HasMaxLength(20).IsUnicode(false);
        });
