...
public static class MoviesEndPoints
{
    public static RouteGroupBuilder MapMoviesEndPoints(this WebApplication app)
    {
        ...
        group.MapGet(
            "/trending",
            async (BookingMovieAppContext dbContext, int limit = 5) =>
            {
        ...
        group
            .MapGet(
                "/{id}",
                async (int id, BookingMovieAppContext dbContext) =>
                {
        ...
        group.MapGet(
            "$/{pattern}",
            async (string pattern, BookingMovieAppContext dbContext) =>
            {
                var movies = await dbContext
        ...
        group.MapPost(
            "/",
            async (CreateMovieDto newMovie, BookingMovieAppContext dbContext) =>
            {
        ...
        group.MapPut(
            "/${id}",
            async (int id, CreateMovieDto updateMovie, BookingMovieAppContext dbContext) =>
            {
        ...
        group.MapGet(
            "/${filter}",
            async (string filter, BookingMovieAppContext dbContext) =>
            {
                DateTime startDate;
                DateTime endDate;
